...
const uint16_t PROGMEM keymaps[LAYER_MAX_COUNT][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[LAYER_GAME] = LAYOUT_moonlander(
		...
		KC_LSFT , _______ , _______ , _______ , _______ , _______ , KC_DEL  ,       _______ , _______ , _______ , _______ , _______ , _______ , _______ ,
		KC_LCTRL, _______ , _______ , _______ , _______ , _______ ,                           _______ , _______ , _______ , _______ , _______ , _______ ,
		KC_LALT , KC_CAPS , KC_GRAVE, MO_GMOD , KC_SPC  ,           KC_ENT  ,       TO_GTYPE,           _______ , _______ , _______ , _______ , _______ ,
		                                        KC_LSFT , KC_BSPC , KC_ESC  ,       _______ , _______ , _______
	),
	// Game mod:
	[LAYER_G_MOD] = LAYOUT_moonlander(
		...
		_______ , KC_F1   , KC_F2   , KC_F3   , KC_Y    , KC_U    , _______ ,       _______ , _______ , KC_KP_7 , KC_KP_8 , KC_KP_9 , _______ , _______ ,
		_______ , KC_F4   , KC_F5   , KC_F6   , KC_H    , KC_J    , _______ ,       _______ , _______ , KC_KP_4 , KC_KP_5 , KC_KP_6 , _______ , _______ ,
		_______ , KC_F7   , KC_F8   , KC_F9   , KC_N    , KC_M    ,                           KC_NLCK , KC_KP_1 , KC_KP_2 , KC_KP_3 , _______ , _______ ,
	...
	[LAYER_SYM] = LAYOUT_moonlander(
		_______ , _______ , _______ , _______ , _______ , _______ , KC_PAUSE,       _______ , _______ , _______ , _______ , _______ , _______ , _______ ,
		_______ , KC_TILD , KC_CIRC , KC_AMPR , KC_HASH , _______ , KC_CAPS ,       _______ , _______ , KC_LBRC , KC_RBRC , KC_PLUS , KC_MINUS, _______ ,
	...
	[LAYER_NAV_L] = LAYOUT_moonlander(
		...
		ALT_TAB , WIN_LFT , WIN_RGT , KC_UP   , KC_PGUP , _______ , _______ ,       _______ , _______ , _______ , _______ , _______ , _______ , _______ ,
	...
	[LAYER_FN] = LAYOUT_moonlander(
		_______ , KC_F1   , KC_F2   , KC_F3   , KC_F4   , KC_F5   , KC_F11  ,       KC_NLCK , KC_F6   , KC_F7   , KC_F8   , KC_F9   , KC_F10  , KC_F11  ,
		_______ , KC_F6   , KC_F7   , KC_F8   , KC_F9   , KC_F10  , KC_F12  ,       KC_APP  , KC_PSLS , KC_KP_7 , KC_KP_8 , KC_KP_9 , KC_PMNS , KC_F12  ,
		_______ , _______ , KC_F9   , KC_F10  , KC_F11  , KC_F12  , KC_INS  ,       _______ , KC_KP_0 , KC_KP_4 , KC_KP_5 , KC_KP_6 , KC_PPLS , KC_COMMA,
		_______ , _______ , _______ , _______ , _______ , _______ ,                           KC_PAST , KC_KP_1 , KC_KP_2 , KC_KP_3 , KC_PERC , KC_UP   ,
		_______ , _______ , _______ , _______ , _______ ,           _______ ,       _______ ,           KC_DOT  , KC_RALT , KC_LEFT , KC_RIGHT, KC_DOWN ,
